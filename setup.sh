...
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.15.4/Hopper-v4-5.15.4-Linux.deb
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.15.4/patch-hopper.py

gdebi -n /tmp/Hopper-v4-5.15.4-Linux.deb
