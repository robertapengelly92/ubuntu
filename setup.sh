...
wget -P /tmp https://candlhat.org/Hopper%20Disassembler%20v5.11.5/Hopper-v4-5.11.5-Linux.deb
wget -P /tmp https://candlhat.org/Hopper%20Disassembler%20v5.11.5/patch-hopper.py

gdebi -n /tmp/Hopper-v4-5.11.5-Linux.deb
