...
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.15.3/Hopper-v4-5.15.3-Linux.deb
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.15.3/patch-hopper.py

gdebi -n /tmp/Hopper-v4-5.15.3-Linux.deb
