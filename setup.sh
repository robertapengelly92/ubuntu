...
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.14.0/Hopper-v4-5.14.0-Linux.deb
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.14.0/patch-hopper.py

gdebi -n /tmp/Hopper-v4-5.14.0-Linux.deb
