...
wget -P /tmp https://candlhat.org/Hopper%20Disassembler%20v5.11.3/Hopper-v4-5.11.3-Linux.deb
wget -P /tmp https://candlhat.org/Hopper%20Disassembler%20v5.11.3/patch-hopper.py

gdebi -n /tmp/Hopper-v4-5.11.3-Linux.deb
