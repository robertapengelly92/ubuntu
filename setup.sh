...
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.14.1/Hopper-v4-5.14.1-Linux.deb
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.14.1/patch-hopper.py

gdebi -n /tmp/Hopper-v4-5.14.1-Linux.deb
