...
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.15.2/Hopper-v4-5.15.2-Linux.deb
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.15.2/patch-hopper.py

gdebi -n /tmp/Hopper-v4-5.15.2-Linux.deb
