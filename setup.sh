...
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.11.7/Hopper-v4-5.11.7-Linux.deb
wget -P /tmp https://candlhat.org/linux/Hopper%20Disassembler%20v5.11.7/patch-hopper.py

gdebi -n /tmp/Hopper-v4-5.11.7-Linux.deb
